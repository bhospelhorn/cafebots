...
public class CMD_EventMakeBiweekly extends CommandAdapter{
	...
	public CMD_EventMakeBiweekly(MessageChannel ch, Member req, int dayOfWeek, List<String> targets, long cmdID)
	{
	...
	public CMD_EventMakeBiweekly(MessageChannel ch, Member req, int dayOfWeek, long cmdID)
	{
		//System.err.println(Thread.currentThread().getName() + " || CMD_EventMakeBiweekly.<init> || DEBUG - Called!");
		comChannel = ch;
		requestingUser = req;
