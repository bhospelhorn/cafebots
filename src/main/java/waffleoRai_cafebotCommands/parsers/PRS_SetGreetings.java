...
import waffleoRai_cafebotCommands.Commands.CMD_SetGreetings;

public class PRS_SetGreetings implements Parser{
	...
	public Command generateCommand(String[] args, MessageReceivedEvent event) {
		...
		return new CMD_SetGreetings(on, event.getMember(), event.getChannel(), event.getMessageIdLong());
	}
