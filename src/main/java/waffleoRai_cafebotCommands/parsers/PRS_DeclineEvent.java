...
import waffleoRai_cafebotCommands.Commands.CMD_DeclineEvent;

public class PRS_DeclineEvent implements Parser{
	...
	public Command generateCommand(String[] args, MessageReceivedEvent event) {
		...
		try
		{
			...
			return new CMD_DeclineEvent(event.getChannel(), event.getMember(), eid, event.getMessageIdLong());
		}
		catch (Exception e)
		{
