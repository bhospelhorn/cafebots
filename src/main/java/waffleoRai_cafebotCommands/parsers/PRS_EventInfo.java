...
import waffleoRai_cafebotCommands.Commands.CMD_EventInfo;

public class PRS_EventInfo implements Parser{
	...
	public Command generateCommand(String[] args, MessageReceivedEvent event) 
	{
		...
		try
		{
			...
			return new CMD_EventInfo(event.getChannel(), event.getMember(), eid, event.getMessageIdLong());
		}
		catch (Exception e)
		{
