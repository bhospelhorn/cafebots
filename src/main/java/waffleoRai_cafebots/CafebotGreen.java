...
public class CafebotGreen extends AbstractBot{
	
	public static final String VERSION = "1.0.0 [18.06.19]";

	public CafebotGreen(String Token, String InitKey, BotBrain core, int localIndex)
	{
	...
	public int getConstructorType() {
		return BotConstructor.CAFEBOT_GREEN;
	}
