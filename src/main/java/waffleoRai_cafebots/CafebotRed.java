...
public class CafebotRed extends AbstractBot{
	
	public static final String VERSION = "1.0.0 [18.06.19]";
	
	public CafebotRed(String Token, String InitKey, BotBrain core, int localIndex)
	{
	...
	public int getConstructorType() {
		return BotConstructor.CAFEBOT_RED;
	}
